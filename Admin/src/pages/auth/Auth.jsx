  ...
  return (
    <div className="h-screen flex font-serif">
      <form className="flex gap-4 flex-col items-center justify-center p-6">
        ...
        <button
          className="outline w-full p-2 rounded-full flex items-center justify-center gap-2 font-bold bg-gradient-to-r from-white via-red-400 to-blue-700 text-black cursor-pointer"
