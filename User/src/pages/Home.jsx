...
function Home() {
  ...
  return (
    ...
    >
      ...
      {/* desktop nav */}
      <nav
        className={`h-fit gap-2 border-b pb-2 w-full flex sticky top-0 ${mode ? "bg-white text-black" : "bg-gray-900 text-white"} p-1`}
      >
        ...
        <div className="hidden md:flex items-center justify-around">
          <div
            id="login"
            className="flex px-3 relative group py-1"
